...
class CarController:
  ...
  def update(self, CC, CS, now_nanos):
    ...
    if self.frame % 2 == 0 and self.CP.carFingerprint in TSS2_CAR:
      ...
      pressing_against = CS.out.steeringTorque * CS.out.steeringTorqueEps < 0
      full_torque_condition = abs(CS.out.steeringTorqueEps) < self.params.STEER_MAX
      # full_torque_condition = (abs(CS.out.steeringTorqueEps) < self.params.STEER_MAX and
      #                          abs(CS.out.steeringTorque) < MAX_DRIVER_TORQUE_ALLOWANCE)
      full_torque_condition = (full_torque_condition and
                               (not pressing_against or abs(CS.out.steeringTorque) < MAX_DRIVER_TORQUE_ALLOWANCE))
